...
[![Build Status](https://travis-ci.com/ufabc-next/ufabc-next-server.svg?branch=master)](https://travis-ci.com/ufabc-next/ufabc-next-server) <img alt="GitHub Issues" src="https://img.shields.io/github/issues/ufabc-next/ufabc-next-server" />
