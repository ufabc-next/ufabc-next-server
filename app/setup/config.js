...
module.exports = async () => {
  ...
  // )
  config.MONGO_URL = 'mongodb://root:NHPVuJm5C79bQdMm@next-db-novo.sv.ufabcnext.com:15003/ufabc-matricula?authSource=admin&readPreference=primary&directConnection=true&ssl=false'
  ...
  config.MATRICULAS_URL = getEnv(
    'MATRICULAS_URL',
    'http://localhost:8011/snapshot/assets/matriculas.js'
  )
  config.DISCIPLINAS_URL = getEnv(
    'DISCIPLINAS_URL',
